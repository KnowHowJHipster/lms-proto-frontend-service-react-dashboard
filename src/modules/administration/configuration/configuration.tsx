...
export const ConfigurationPage = () => {
  ...
  const changeFilter = (evt: { target: { value: SetStateAction<string> } }) =>
    setFilter(evt.target.value);

  const envFilterFn = (configProp: string) =>
    configProp.toUpperCase().includes(filter.toUpperCase());

  const propsFilterFn = (configProp: { prefix: string }) =>
  ...
  return (
    <div>
      <h2 data-cy="configurationPageHeading" id="configuration-page-heading">
