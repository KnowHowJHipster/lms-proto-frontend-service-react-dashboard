...
describe('User management reducer tests', () => {
  ...
  describe('Requests', () => {
    it('should not modify the current state', () => {
      testInitialState(
        userManagement(undefined, { type: getRoles.pending.type })
      );
    });
  ...
  describe('Success', () => {
    it('should update state according to a successful fetch users request', () => {
      ...
      const toTest = userManagement(undefined, {
  ...
  describe('Reset', () => {
    it('should reset the state', () => {
      ...
      expect(userManagement(initialStateNew, reset)).eq(initialState);
    });
  });
